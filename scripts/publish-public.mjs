...
const COPY_SCRIPT_FILES = [
  ...
  'scripts/font-downloads.mjs',
  'scripts/web-fonts.json',
  'scripts/ensure-reading-fonts.ps1',
  'scripts/ensure-reading-style.mjs',
  'scripts/expand-reading-style.ps1',
  'scripts/reading-cdp.mjs',
  'scripts/verify-reading-style.mjs',
  'scripts/ensure-runner-developer-mode.mjs',
